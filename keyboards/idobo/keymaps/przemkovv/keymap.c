...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_GM] = LAYOUT_ortho_5x15( \
    KC_ESC,  KC_1,    KC_2,    KC_3,     KC_4,     KC_5,     KC_6,       KC_7,       KC_8,       KC_9,    KC_0,    KC_MINS,  KC_EQL,   KC_DEL,   KC_BSPC, \
    KC_TAB,  KC_Q,    KC_W,    KC_E,     KC_R,     KC_T,     KC_KP_7,    KC_KP_8,    KC_KP_9,    KC_Y,    KC_U,    KC_I,     KC_O,     KC_P,     KC_BSLS,  \
    KC_CAPS, KC_A,    KC_S,    KC_D,     KC_F,     KC_G,     KC_KP_4,    KC_KP_5,    KC_KP_6,    KC_H,    KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,     KC_V,     KC_B,     KC_KP_1,    KC_KP_2,    KC_KP_3,    KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, MO(_FL),  KC_SPC,   KC_SPC,   KC_LBRC,    KC_KP_0,    KC_RBRC,    KC_ENT,  KC_RALT,  KC_APP,  KC_RCTL,  KC_DOWN,  KC_UP  \
  ),
 /* [_BL] = LAYOUT_ortho_5x15( \ */
    /* KC_ESC,  KC_1,    KC_2,    KC_3,     KC_4,     KC_5,     KC_6,       KC_7,       KC_8,       KC_9,    KC_0,    KC_MINS,  KC_EQL,   KC_DEL,   KC_BSPC,  \ */
    /* KC_TAB,  KC_Q,    KC_W,    KC_E,     KC_R,     KC_T,     KC_KP_7,    KC_KP_8,    KC_KP_9,    KC_Y,    KC_U,    KC_I,     KC_O,     KC_P,     KC_BSLS,  \ */
 ...
 [_FL] = LAYOUT_ortho_5x15( \
    ...
    ______I, ______I, ______I, ______I, ______I, ______I, DF(_BL), DF(_GM), ______I, ______I, ______I, ______I, ______I, ______I, ______I, \
    ______I, ______I, ______I, ______I, ______I, ______I, ______I, ______I, ______I, ______I, ______I, ______I, ______I, ______I, _______ \
  ),
 [_CL] = LAYOUT_ortho_5x15( \
    ...
    ______I, ______I, ______I, ______I, ______I, ______I, ______I, RESET,   ______I, ______I, ______I, ______I, ______I, ______I, _______ \
  ),
};
